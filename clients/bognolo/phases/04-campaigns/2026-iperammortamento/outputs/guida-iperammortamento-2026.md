...
- **Macchine e impianti 4.0:** macchine utensili, linee, confezionamento, additive manufacturing
- **Robotica e logistica:** robot, cobot, AGV, movimentazione, magazzini automatizzati
- **Qualità, energia e sicurezza:** sistemi di misura/collaudo, tracciabilità, monitoraggio consumi, ergonomia

### B — Beni immateriali (Allegato V)

- **Progettazione e digital engineering:** CAD/PLM, modellazione 3D, simulazione
- **Produzione e interconnessione:** MES, SCADA, CMMS, IoT/edge/cloud
- **Dati, AI e sicurezza:** AI/ML, digital twin, cybersecurity, EMS, AR/VR

### C — Fotovoltaico e autoproduzione da FER

- Impianti per l'autoproduzione di energia da fonti rinnovabili destinata all'autoconsumo
- Gruppi di generazione, trasformatori, misuratori, servizi ausiliari
- Impianti per la produzione di energia termica con elettrificazione dei consumi
- **Sistemi di stoccaggio (BESS):** agevolabili **solo se abbinati all'acquisto di nuovi sistemi FER** (non possono essere installati da soli a servizio di impianti preesistenti)
- I pannelli fotovoltaici devono essere iscritti nel **Registro ENEA** lettere b) o c)

> Gli esempi sopra sono indicativi e non esaustivi. Conta la verifica puntuale dei requisiti previsti dalla normativa.
...
- D.L. 27 marzo 2026, n. 38 — rimozione vincolo territoriale "Made in UE/SEE"
...
- Decreto interministeriale MIMIT/MEF (in corso di pubblicazione in GU — atteso entro fine maggio 2026)

---

*Studio Marco Bognolo — Ingegneria Industriale | www.bognolo.it*
*Analisi preliminare e supporto tecnico per imprese*
